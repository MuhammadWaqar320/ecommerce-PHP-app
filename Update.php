...
<body style="background:peru">
    ...
    <nav class="navbar navbar-danger " style="background-color:yellowgreen">
            ...
            <th style="border:1px solid black;padding:10px;text-align:center;background-color:yellow;">Edit</th>
            </tr>
                  <?php
                        ...
                        if(mysqli_num_rows($run)<1){
                            ...
                            while($data=mysqli_fetch_assoc($run)){
                              ...
                              <tr>
                                 ...
                                 <td style="border:1px solid black;padding:10px;text-align:center;background-color:skyblue;"><a href="updateform.php?pid=<?php echo $data['pro_id']?>">Edit</a></td>
                              </tr>
                              <?php
                            }
                        }
